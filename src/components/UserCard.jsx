...
function UserCard({ img, titulo, mensaje, fecha, adjunto }) {
  ...
  return (
    <div className="flex justify-center items-center mt-[100px] overflow-x-hidden">
      <div className="relative w-full xl:h-64 max-w-[400px] xl:w-full xl:max-w-[90vw] mx-4 flex xl:flex-row flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-xl">
        ...
        <div className="p-6 xl:flex-1">
          <div className="flex">
            ...
            <div className="flex-2">
              <h5 className="mb-2 block flex-1 font-sans text-xl font-semibold leading-snug tracking-normal text-blue-500 antialiased">
                {fecha}
              </h5>
              <div className="p-6 pt-4 xl:py-0 flex-1">
                <button
                  ...
                  type="button"
                  className="select-none mt-[10px] ml-[-20px] rounded-lg bg-blue-500 py-[10px] px-[10px] text-center text-nowrap align-middle font-sans text-[14px] font-bold uppercase text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
